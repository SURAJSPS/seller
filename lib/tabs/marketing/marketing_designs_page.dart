  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          body: new Container(width: MediaQuery.of(context).size.width,alignment: Alignment.topCenter,

            child: Wrap(
            alignment: WrapAlignment.start,
            children: [
              MarketingCard('Business', Icons.archive_sharp, Colors.blue),
              MarketingCard('Promo Banners', Icons.arrow_circle_down_rounded, Colors.black),
